            ...
            <form onSubmit={handleSubmit(onSubmit)} className="contact-form space-y-6">
              ...
              <div>
                ...
                <select
                  {...register('service')}
                  id="service"
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-servitec-orange focus:border-servitec-orange transition-all duration-300 text-gray-900 bg-white hover:border-gray-400"
                >
